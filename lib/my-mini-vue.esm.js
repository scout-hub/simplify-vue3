 ...
 * @LastEditors: Zhouqi
 * @LastEditTime: 2022-04-05 14:09:32
 */
/**
 * @description: 自定义渲染器
...
function baseCreateRenderer(options) {
    ...
    const patchKeyedChildren = (c1, c2, container, parentAnchor, parentComponent) => {
        ...
        // 2、i <= oldEnd：这个条件成立说明旧的子节点还有没有遍历的，这些节点就是需要删除的节点
             ...
             * (a) b c (d) ====> (a) (d) ：b、c是需要删除的节点，c要插入到e节点的前面，所以e是锚点元素，e节点的索引为 newEnd+1
             */
            while (i <= oldEnd) {
                hostRemove(c1[i].el);
                i++;
...
export { ReactiveEffect, canTrack, createApp, createRenderer, createTextVnode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, provide, proxyRefs, reactive, readonly, ref, renderSlot, shallowReactive, shallowReadonly, shallowRef, stop, toRaw, toRef, toRefs, track, trackEffects, trackRefValue, trigger, triggerEffects, unRef };
