...
export { BaseTransition, ITERATE_KEY, KeepAlive, MAP_KEY_ITERATE_KEY, ReactiveEffect, Teleport, Transition, canTrack, createApp, createCommentVnode, createVnode as createElementBlock, createRenderer, createTextVnode, defineAsyncComponent, defineComponent, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onMounted, onUnmounted, onUpdated, pauseTracking, provide, proxyRefs, reactive, reactiveMap, readonly, readonlyMap, ref, registerRuntimeCompiler, renderSlot, resetTracking, shallowReactive, shallowReactiveMap, shallowReadonly, shallowReadonlyMap, shallowRef, stop, toDisplayString, toRaw, toReactive, toReadonly, toRef, toRefs, track, trackEffects, trackRefValue, trigger, triggerEffects, triggerRefValue, unRef, watch, watchEffect, watchPostEffect };
